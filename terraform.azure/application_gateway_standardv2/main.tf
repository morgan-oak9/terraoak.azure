...
resource "azurerm_application_gateway" "sac_application_gateway_standardv2_predefined" {
  ...
  # SaC Testing - Severity: Moderate - Set zones to undefined
  #zones = ["2"]
  ...
  # SaC Testing - Severity: Moderate - Set autoscale_configuration to undefined
  autoscale_configuration {
    # SaC Testing - Severity: Moderate - Set min_capacity < 2
    min_capacity = 1
    max_capacity = 25
  }
  ...
  frontend_ip_configuration {
    ...
    # SaC Testing - Severity: - Set public_ip_address_id to undefined
